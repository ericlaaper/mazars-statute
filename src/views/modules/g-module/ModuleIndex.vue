...
<script>
import sectionData from "@/assets/modules/sectionG.json";
import stats from "@/assets/modules/moduleG.json";
import vimeo from "@/assets/vimeo/vimeo.json";
import StepComponentStart from "@/views/modules/g-module/StepComponentStart.vue";
import StepComponentA from "@/views/modules/g-module/StepComponentA.vue";
import StepComponentB from "@/views/modules/g-module/StepComponentB.vue";
import StepComponentC from "@/views/modules/g-module/StepComponentC.vue";
import StepComponentD from "@/views/modules/g-module/StepComponentD.vue";
import StepComponentE from "@/views/modules/g-module/StepComponentE.vue";
import StepComponentF from "@/views/modules/g-module/StepComponentF.vue";
import StepComponentG from "@/views/modules/g-module/StepComponentG.vue";
import StepComponentH from "@/views/modules/g-module/StepComponentH.vue";
import StepComponentI from "@/views/modules/g-module/StepComponentI.vue";
...
export default {
  ...
  methods: {
    async onSubmit() {
      ...
      if (
        ...
        await this.$store.commit("moduleG/stepUpNr", 10);
      } else if (
        this.moduleData.step === 0 &&
        !this.visData.section_1 &&
        !this.visData.section_2 &&
        ...
        await this.$store.commit("moduleG/stepUpNr", 9);
      } else if (
        this.moduleData.step === 0 &&
        !this.visData.section_1 &&
        !this.visData.section_2 &&
        ...
        await this.$store.commit("moduleG/stepUpNr", 8);
      } else if (
        this.moduleData.step === 0 &&
        !this.visData.section_1 &&
        !this.visData.section_2 &&
        ...
        await this.$store.commit("moduleG/stepUpNr", 7);
      } else if (
        this.moduleData.step === 0 &&
        !this.visData.section_1 &&
        !this.visData.section_2 &&
        ...
        await this.$store.commit("moduleG/stepUpNr", 6);
      } else if (
        this.moduleData.step === 0 &&
        !this.visData.section_1 &&
        !this.visData.section_2 &&
        ...
        await this.$store.commit("moduleG/stepUpNr", 5);
      } else if (
        this.moduleData.step === 0 &&
        !this.visData.section_1 &&
        !this.visData.section_2 &&
        ...
        await this.$store.commit("moduleG/stepUpNr", 4);
      } else if (
        this.moduleData.step === 0 &&
        !this.visData.section_1 &&
        !this.visData.section_2 &&
        ...
        await this.$store.commit("moduleG/stepUpNr", 3);
      } else if (
        this.moduleData.step === 0 &&
        !this.visData.section_1 &&
        this.visData.section_2
      ) {
        await this.$store.commit("moduleG/stepUpNr", 2);
      } else if (this.moduleData.step === 0 && this.visData.section_1) {
        await this.$store.commit("moduleG/stepUpNr", 1);
      } else if (
        ...
        await this.$store.commit("moduleG/update_ready_a", true);
        await this.$store.commit("moduleG/stepUpNr", 9);
      } else if (
        this.moduleData.step === 1 &&
        !this.visData.section_2 &&
        ...
        await this.$store.commit("moduleG/update_ready_b", true);
        await this.$store.commit("moduleG/stepUpNr", 8);
      } else if (
        this.moduleData.step === 2 &&
        !this.visData.section_3 &&
        ...
        await this.$store.commit("moduleG/update_ready_c", true);
        await this.$store.commit("moduleG/stepUpNr", 7);
      } else if (
        this.moduleData.step === 3 &&
        !this.visData.section_4 &&
        ...
        await this.$store.commit("moduleG/update_ready_d", true);
        await this.$store.commit("moduleG/stepUpNr", 6);
      } else if (
        this.moduleData.step === 4 &&
        !this.visData.section_5 &&
        ...
        await this.$store.commit("moduleG/update_ready_e", true);
        await this.$store.commit("moduleG/stepUpNr", 5);
      } else if (
        this.moduleData.step === 5 &&
        !this.visData.section_6 &&
        ...
        await this.$store.commit("moduleG/update_ready_f", true);
        await this.$store.commit("moduleG/stepUpNr", 4);
      } else if (
        this.moduleData.step === 6 &&
        !this.visData.section_7 &&
        ...
        await this.$store.commit("moduleG/update_ready_g", true);
        await this.$store.commit("moduleG/stepUpNr", 3);
      } else if (
        this.moduleData.step === 7 &&
        !this.visData.section_8 &&
        ...
        await this.$store.commit("moduleG/update_ready_h", true);
        await this.$store.commit("moduleG/stepUpNr", 1);
      } else if (this.moduleData.step === 9) {
        await this.$store.commit("moduleG/update_ready_i", true);
        await this.$store.commit("moduleG/stepUpNr", 1);
      }
      await this.$store.dispatch("moduleG/setModulesData");
    },
    async stepBack() {
      await this.$vuetify.goTo(0);
      if (
        ...
        await this.$store.commit("moduleG/stepDownNr", 10);
      } else if (
        this.moduleData.step === 10 &&
        !this.visData.section_9 &&
        !this.visData.section_8 &&
        ...
        await this.$store.commit("moduleG/stepDownNr", 9);
      } else if (
        this.moduleData.step === 10 &&
        !this.visData.section_9 &&
        !this.visData.section_8 &&
        ...
        await this.$store.commit("moduleG/stepDownNr", 8);
      } else if (
        this.moduleData.step === 10 &&
        !this.visData.section_9 &&
        !this.visData.section_8 &&
        ...
        await this.$store.commit("moduleG/stepDownNr", 7);
      } else if (
        this.moduleData.step === 10 &&
        !this.visData.section_9 &&
        !this.visData.section_8 &&
        ...
        await this.$store.commit("moduleG/stepDownNr", 6);
      } else if (
        this.moduleData.step === 10 &&
        !this.visData.section_9 &&
        !this.visData.section_8 &&
        ...
        await this.$store.commit("moduleG/stepDownNr", 5);
      } else if (
        this.moduleData.step === 10 &&
        !this.visData.section_9 &&
        !this.visData.section_8 &&
        ...
        await this.$store.commit("moduleG/stepDownNr", 4);
      } else if (
        this.moduleData.step === 10 &&
        !this.visData.section_9 &&
        !this.visData.section_8 &&
        ...
        await this.$store.commit("moduleG/stepDownNr", 3);
      } else if (
        this.moduleData.step === 10 &&
        !this.visData.section_9 &&
        this.visData.section_8
      ) {
        await this.$store.commit("moduleG/stepDownNr", 2);
      } else if (this.moduleData.step === 10 && this.visData.section_9) {
        await this.$store.commit("moduleG/stepDownNr", 1);
      } else if (
    ...
    backStart() {
      this.$store.commit("moduleG/update_step", 0);
    },
    async getReport() {
      await this.$store.commit("moduleG/update_finished", true);
      await this.$store.dispatch("moduleG/setModulesData");
      const payload = {
        email: this.email,
      };
      ...
      ReportService.getReportG(payload)
        .then(() => {})
        .finally(() => {
  ...
  computed: {
    ...
    ...mapGetters("visG", ["visData"]),
    ...mapGetters("moduleG", ["moduleData"]),
  },
  async created() {
    const payload = {
      email: this.email,
    ...
    await this.$store.dispatch("visG/getVisData", payload);
    await this.$store.dispatch("moduleG/getModulesData", payload);
  },
};
</script>
